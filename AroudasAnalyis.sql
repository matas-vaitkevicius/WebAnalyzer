...
--(ads.price/ads.LivingArea) per_sq_m, (ads.price/ads.LivingArea)/(analysis.sq) avg_town_ratio, (ads.price/ads.LivingArea)/(analysis.l_sq) avg_local_ratio, (ads.LivingArea*analysis.l_r_sq)-ads.ServiceCosts rent_per_month, ads.Price/(((ads.LivingArea*analysis.l_r_sq)-ads.ServiceCosts)*12) years_to_pay_for_itself,
 * from (
select * from
...
where analysis.l_cnt > 2 and analysis.l_r_cnt > 2 and analysis.l_roomC > 0 

order by analysis.l_years 